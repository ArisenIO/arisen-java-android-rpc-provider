...
import one.block.arisenjava.error.rpcProvider.GetRawAbiRpcError;
...
import one.block.arisenjavarpcprovider.BuildConfig;
import one.block.arisenjavarpcprovider.error.ArisenJavaRpcErrorConstants;
 ...
 */
public class ArisenJavaRpcProviderImpl implements IRPCProvider {
    ...
    @NotNull
    private IArisenJavaRpcProviderApi rpcProviderApi;
     ...
     * @throws ArisenJavaRpcProviderInitializerError thrown if the base URL passed in is null.
     */
    public ArisenJavaRpcProviderImpl(@NotNull String baseURL) throws ArisenJavaRpcProviderInitializerError {
        this(baseURL, false);
    }
     ...
     * @throws ArisenJavaRpcProviderInitializerError thrown if the base URL passed in is null.
     */
    public ArisenJavaRpcProviderImpl(@NotNull String baseURL, boolean enableDebug) throws ArisenJavaRpcProviderInitializerError {
        if(baseURL == null || baseURL.isEmpty()) {
            throw new ArisenJavaRpcProviderInitializerError(ArisenJavaRpcErrorConstants.RPC_PROVIDER_BASE_URL_EMPTY);
        }
        ...
        this.rpcProviderApi = this.retrofit.create(IArisenJavaRpcProviderApi.class);
    }
     ...
     * @throws Exception Can throw ArisenJavaRpcProviderCallError for RPC provider specific
    ...
    private <O> O processCall(Call<O> call) throws Exception {
        ...
        if (!response.isSuccessful()) {
            String additionalErrInfo = ArisenJavaRpcErrorConstants.RPC_PROVIDER_NO_FURTHER_ERROR_INFO;
            ...
            if (response.errorBody() != null) {
                ...
                if (rpcResponseError == null) {
                    ...
                    additionalErrInfo = ArisenJavaRpcErrorConstants.RPC_PROVIDER_SEE_FURTHER_ERROR_INFO;
                }
            }

            String msg = String.format(Locale.getDefault(), ArisenJavaRpcErrorConstants.RPC_PROVIDER_BAD_STATUS_CODE_RETURNED,
                    response.code(), response.message(), additionalErrInfo);
            throw new ArisenJavaRpcProviderCallError(msg, rpcResponseError);
        }
        if (response.body() == null) {
            throw new ArisenJavaRpcProviderCallError(ArisenJavaRpcErrorConstants.RPC_PROVIDER_EMPTY_RESPONSE_RETURNED);
        }
    ...
    public @NotNull GetInfoResponse getInfo() throws GetInfoRpcError {
        try {
            ...
            throw new GetInfoRpcError(ArisenJavaRpcErrorConstants.RPC_PROVIDER_ERROR_GETTING_CHAIN_INFO,
                    ex);
        }
    }
    ...
    public @NotNull GetBlockResponse getBlock(GetBlockRequest getBlockRequest)
        ...
        try {
            ...
            throw new GetBlockRpcError(ArisenJavaRpcErrorConstants.RPC_PROVIDER_ERROR_GETTING_BLOCK_INFO,
                    ex);
        }
    }
    ...
    public @NotNull GetRawAbiResponse getRawAbi(GetRawAbiRequest getRawAbiRequest)
        ...
        try {
            ...
            throw new GetRawAbiRpcError(ArisenJavaRpcErrorConstants.RPC_PROVIDER_ERROR_GETTING_RAW_ABI,
                    ex);
        }
    }
    ...
    public @NotNull GetRequiredKeysResponse getRequiredKeys(
        ...
        try {
            ...
            throw new GetRequiredKeysRpcError(ArisenJavaRpcErrorConstants.RPC_PROVIDER_ERROR_GETTING_REQUIRED_KEYS,
                    ex);
        }
    }
    ...
    public @NotNull PushTransactionResponse pushTransaction(
        ...
        try {
            ...
            throw new PushTransactionRpcError(ArisenJavaRpcErrorConstants.RPC_PROVIDER_ERROR_PUSHING_TRANSACTION,
                    ex);
        }
    }
    ...
    public @NotNull String getAccount(RequestBody requestBody) throws RpcProviderError {
        try {
            ...
            throw new RpcProviderError(ArisenJavaRpcErrorConstants.RPC_PROVIDER_ERROR_GET_ACCOUNT, ex);
        }
    }
    ...
    public @NotNull String pushTransactions(RequestBody requestBody) throws RpcProviderError {
        try {
            ...
            throw new RpcProviderError(ArisenJavaRpcErrorConstants.RPC_PROVIDER_ERROR_PUSHING_TRANSACTIONS, ex);
        }
    }
    ...
    public @NotNull String getBlockHeaderState(RequestBody requestBody) throws RpcProviderError {
        try {
            ...
            throw new RpcProviderError(ArisenJavaRpcErrorConstants.RPC_PROVIDER_ERROR_GET_BLOCK_HEADER_STATE, ex);
        }
    }
    ...
    public @NotNull String getAbi(RequestBody requestBody) throws RpcProviderError {
        try {
            ...
            throw new RpcProviderError(ArisenJavaRpcErrorConstants.RPC_PROVIDER_ERROR_GET_ABI, ex);
        }
    }
    ...
    public @NotNull String getCurrencyBalance(RequestBody requestBody) throws RpcProviderError {
        try {
            ...
            throw new RpcProviderError(ArisenJavaRpcErrorConstants.RPC_PROVIDER_ERROR_GET_CURRENT_BALANCE, ex);
        }
    }
    ...
    public @NotNull String getCurrencyStats(RequestBody requestBody) throws RpcProviderError {
        try {
            ...
            throw new RpcProviderError(ArisenJavaRpcErrorConstants.RPC_PROVIDER_ERROR_GET_CURRENT_STATS, ex);
        }
    }
    ...
    public @NotNull String getProducers(RequestBody requestBody) throws RpcProviderError {
        try {
            ...
            throw new RpcProviderError(ArisenJavaRpcErrorConstants.RPC_PROVIDER_ERROR_GET_PRODUCERS, ex);
        }
    }
    ...
    public @NotNull String getRawCodeAndAbi(RequestBody requestBody) throws RpcProviderError {
        try {
            ...
            throw new RpcProviderError(ArisenJavaRpcErrorConstants.RPC_PROVIDER_ERROR_GET_RAW_CODE_AND_ABI, ex);
        }
    }
    ...
    public @NotNull String getTableByScope(RequestBody requestBody) throws RpcProviderError {
        try {
            ...
            throw new RpcProviderError(ArisenJavaRpcErrorConstants.RPC_PROVIDER_ERROR_GET_TABLE_BY_SCOPE, ex);
        }
    }
    ...
    public @NotNull String getTableRows(RequestBody requestBody) throws RpcProviderError {
        try {
            ...
            throw new RpcProviderError(ArisenJavaRpcErrorConstants.RPC_PROVIDER_ERROR_GET_TABLE_ROWS, ex);
        }
    }
    ...
    public @NotNull String getCode(RequestBody requestBody) throws RpcProviderError {
        try {
            ...
            throw new RpcProviderError(ArisenJavaRpcErrorConstants.RPC_PROVIDER_ERROR_GET_CODE, ex);
        }
    }
    ...
    public @NotNull String getActions(RequestBody requestBody) throws RpcProviderError {
        try {
            ...
            throw new RpcProviderError(ArisenJavaRpcErrorConstants.RPC_PROVIDER_ERROR_GET_ACTION, ex);
        }
    }
    ...
    public @NotNull String getTransaction(RequestBody requestBody) throws RpcProviderError {
        try {
            ...
            throw new RpcProviderError(ArisenJavaRpcErrorConstants.RPC_PROVIDER_ERROR_GET_TRANSACTION, ex);
        }
    }
    ...
    public @NotNull String getKeyAccounts(RequestBody requestBody) throws RpcProviderError {
        try {
            ...
            throw new RpcProviderError(ArisenJavaRpcErrorConstants.RPC_PROVIDER_ERROR_GET_KEY_ACCOUNTS, ex);
        }
    }
    ...
    public @NotNull String getControlledAccounts(RequestBody requestBody) throws RpcProviderError {
        try {
            ...
            throw new RpcProviderError(ArisenJavaRpcErrorConstants.RPC_PROVIDER_ERROR_GET_CONTROLLED_ACCOUNTS, ex);
        }
    }
}
