...
import static one.block.testarisenjavarpcprovider.RpcTestContants.*;
...
public class ArisenRpcProviderInstrumentedTest {
    ...
    public void testGetAbiRpcCall() {
        ...
        try {
            ...
            assertNotNull(response);
            JSONObject jsonObject = new JSONObject(response);
            assertEquals("arisen.token", jsonObject.getString("account_name"));
        } catch (Exception ex) {
    ...
    public void testGetCurrencyBalanceRpcCall() {
        ...
        try {
            ...
            assertNotNull(response);
            JSONArray jsonArray = new JSONArray(response);
            assertEquals("1.0000 RIX", jsonArray.getString(0));
        } catch (Exception ex) {
    ...
    public void testGetCurrencyStatsRpcCall() {
        ...
        try {
            ...
            assertEquals("100000000.0000 RIX", json.getJSONObject("RIX").getString("supply"));
            assertEquals("10000000000.0000 RIX", json.getJSONObject("RIX").getString("max_supply"));
        } catch (Exception ex) {
    ...
    public void testGetRawCodeAndAbiRpcCall() {
        ...
        try {
            ...
            assertNotNull(response);
            JSONObject json = new JSONObject(response);
            assertEquals("arisen.token", json.getString("account_name"));
        } catch (Exception ex) {
    ...
    public void testGetTableByScopeRpcCall() {
        ...
        try {
            ...
            assertEquals("arisen.token", json.getJSONArray("rows").getJSONObject(0).getString("code"));
    ...
    public void testGetTableRowsRpcCall() {
        ...
        try {
            ...
            assertEquals("1000.0000 RIX", json.getJSONArray("rows").getJSONObject(0).getString("balance"));
        } catch (Exception ex) {
