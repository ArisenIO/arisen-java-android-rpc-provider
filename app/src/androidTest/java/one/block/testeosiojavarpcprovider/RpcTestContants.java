package one.block.testarisenjavarpcprovider;

public class RpcTestContants {
    ...
    public static final String GET_RAW_ARISEN_TOKEN_ABI_RESPONSE = "{\n"
    ...
    public static final String GET_ACCOUNT_RESPONSE = "{\n" +
            ...
            "    \"total_resources\": {\n" +
            "        \"owner\": \"test_account\",\n" +
            "        \"net_weight\": \"100.0000 RIX\",\n" +
            "        \"cpu_weight\": \"100.0000 RIX\",\n" +
            "        \"ram_bytes\": 8149\n" +
            "    },\n" +
    ...
    public static final String GET_BLOCK_HEADER_STATE_RESPONSE = "{\n" +
            ...
            "                \"block_signing_key\": \"RSN5DgtLq5fSqsc6SD3SD98Tu5P7dirfNdnD3pjCLtURiDWTQ6pzV\"\n" +
            "            },\n" +
            "            {\n" +
            "                \"producer_name\": \"blkproducer2\",\n" +
            "                \"block_signing_key\": \"RSN8QEPQ1wiZrdHavectXNpMy3TpcyYGXSVfkVGhyVTaJ7FT8bzCZ\"\n" +
            "            },\n" +
            "            {\n" +
            "                \"producer_name\": \"blkproducer3\",\n" +
            "                \"block_signing_key\": \"RSN7YTjjzt7coagRE5i64JhZB4ucH23Nz5mDhXdzU6QC7gfXwy8M9\"\n" +
            "            }\n" +
            "        ]\n" +
            "    },\n" +
            "    \"blockroot_merkle\": {\n" +
    ...
    public static final String GET_PRODUCER_RESPONSE = "{\n" +
            ...
            "            \"producer_key\": \"RSN8QEPQ1wiZrdHavectXNpMy3TpcyYGXSVfkVGhyVTaJ7FT8bzCZ\",\n" +
            "            \"is_active\": 1,\n" +
            "            \"url\": \"\",\n" +
            "            \"unpaid_blocks\": 0,\n" +
            ...
            "            \"owner\": \"blkproducer3\",\n" +
            "            \"total_votes\": \"0.00000000000000000\",\n" +
            "            \"producer_key\": \"RSN7YTjjzt7coagRE5i64JhZB4ucH23Nz5mDhXdzU6QC7gfXwy8M9\",\n" +
            "            \"is_active\": 1,\n" +
            "            \"url\": \"\",\n" +
            "            \"unpaid_blocks\": 0,\n" +
